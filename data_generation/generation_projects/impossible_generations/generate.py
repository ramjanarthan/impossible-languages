...
for perturbation in [ "reverse_full", "reverse_partial", "shuffle_local3", "shuffle_local5", "shuffle_local10"]:
    ...
    for i in range(NUM_LINES):
        ...
        undo_input =  UNDO_PERTURBATIONS[perturbation]['gpt2_tokenizer'].encode(generated_text) #output[0].tolist()
