...
class EnglishToFullReverseForAnaphorAgreementNumericalGenerator(data_generator.ParallelBenchmarkGenerator):
    def __init__(self):
        super().__init__(field="morphology",
                         linguistics="anaphor_agreement",
                         uid="english_to_full_reverse_for_anaphor_agreement_numerical",
    ...
    def sample(self):
        ...
        # knows himself The boy
        # V1    refl_match   N1
        # knows themselves The boy
        # V1    refl_mismatch   N1
...
binding_generator = EnglishToFullReverseForAnaphorAgreementNumericalGenerator()
