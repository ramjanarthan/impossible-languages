...
DATASET_BASE_PATH="data_generation/outputs/impossible_blimp/v2/anaphor_number_agreement_20250617_153306"

# Create a log file
LOG_FILE="experiments/v2/trajectory/anaphor_number_agreement.log"

# Create a results file
RESULTS_FILE="experiments/output/v2/trajectory/anaphor_number_agreement_results.csv"

# Experiment name
EXPERIMENT_NAME="anaphor_number_agreement"
