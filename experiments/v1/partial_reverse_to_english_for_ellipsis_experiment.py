...
def main():
    # Dataset path
    dataset_path = "data_generation/outputs/impossible_blimp/english_to_partial_reverse_for_ellipsis.jsonl"
    
    # Model names
    model1_name = "mission-impossible-lms/partial-reverse-gpt2"
