...
def main():
    # Dataset path
    dataset_path = "data_generation/outputs/impossible_blimp/english_to_full_reverse_for_anaphor_agreement_numerical.jsonl"
    
    # Model names
    model1_name = "mission-impossible-lms/full-reverse-gpt2"
