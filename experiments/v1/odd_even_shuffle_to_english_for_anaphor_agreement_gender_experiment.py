...
def main():
    # Dataset path
    dataset_path = "data_generation/outputs/impossible_blimp/english_to_odd_even_shuffle_for_anaphor_agreement_gender.jsonl"
    
    # Model names
    model1_name = "mission-impossible-lms/even-odd-shuffle-gpt2"
